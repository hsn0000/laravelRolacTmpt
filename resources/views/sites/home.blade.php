					...
					<div class="row fullscreen d-flex align-items-center justify-content-between">
						<div class="banner-content col-lg-9 col-md-12">
							<h1 class="text-uppercase">
								{{config('sekolah.wellcome_message')}}			
							</h1>
							<p class="pt-10 pb-10">
								{{config('sekolah.sub_wellcome_message')}}
							</p>
							<a href="/register" class="primary-btn text-uppercase">Untuk Pendaftaran</a>
						</div>										
					</div>
				</div>					
			</section>
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="single-feature">
								<div class="title">
									<h4> {{config('sekolah.home_feature_colomn_1_title')}} </h4>
								</div>
								<div class="desc-wrap">
									<p>
									{{config('sekolah.home_feature_colomn_1_context')}}
									</p>
									<a href="{{config('sekolah.home_feature_colomn_1_url')}}">{{config('sekolah.home_feature_colomn_1_link_text')}}</a>									
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="single-feature">
								<div class="title">
									<h4>{{config('sekolah.home_feature_colomn_2_title')}}</h4>
								</div>
								<div class="desc-wrap">
									<p>
									{{config('sekolah.home_feature_colomn_2_context')}}
									</p>
									<a href="{{config('sekolah.home_feature_colomn_2_url')}}">{{config('sekolah.home_feature_colomn_2_link_text')}}</a>									
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="single-feature">
								<div class="title">
								<h4>{{config('sekolah.home_feature_colomn_3_title')}}</h4>
								</div>
								<div class="desc-wrap">
									<p>
									{{config('sekolah.home_feature_colomn_3_context')}}
									</p>
									<a href="{{config('sekolah.home_feature_colomn_3_url')}}">{{config('sekolah.home_feature_colomn_3_link_text')}}</a>								
								</div>
							</div>
						</div>												
					</div>
